...
export default function DoctorPatientsPage() {
  ...
  // Active detail modal / drawer tab state
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex flex-col md:flex-row transition-colors duration-300">
      ...
      <main className="flex-1 p-6 lg:p-10 flex flex-col gap-6 max-w-6xl mx-auto w-full">
              ...
              {filteredPatients.map((p) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`p-6 rounded-3xl border shadow-sm flex flex-col justify-between transition-all duration-300 relative ${
                      isSelected
                        ? 'bg-gradient-to-br from-emerald-50/60 to-white border-emerald-300 dark:from-emerald-950/40 dark:to-slate-900 dark:border-emerald-500/50 shadow-md'
                        : 'bg-white border-gray-100 dark:bg-slate-900 dark:border-slate-800 hover:border-gray-300 dark:hover:border-slate-700'
                    }`}
                  >
                    <div>
        ...
        {/* Selected Patient Full Detail Drawer / View */}
        <AnimatePresence>
          {selectedPatientId && (
            <motion.div
